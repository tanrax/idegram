import { reactive, getCurrentInstance, version, unref, isRef, inject, ref, watchEffect, watch, toRef, nextTick, shallowRef, computed, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6c73210b.js").then((m) => m.default || m)
  },
  {
    name: "single-id",
    path: "/single/:id",
